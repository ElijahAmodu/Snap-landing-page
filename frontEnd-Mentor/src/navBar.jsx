...
function NavBar () {
   ...
   function listToggleFeature () {
        setIsFeature(prevState => !prevState);
   }

   function listToggleCompany () {
    ...
    return (  
        <div className="nav-content">
            <div className="nav-logo">
                ...
                <div className="hamburger" onClick={menuUpdate}>
            ...
            <div className="nav-icon">
                    <div className={isChanged ? "overlayOpen" : "overlayClose"}></div>
                    <div className={isChanged ? "listContainerOpen" : "listContainerClose"}> 
                    <div className="closeMenu" onClick={menuUpdate}>  
                    ...
                    <ul className="navUlWrapper">
                        <div className="listSvg">
                            <li onClick={listToggleFeature}>Features</li>
                            {isFeature ? <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" strokeWidth="1.5" fill="none" d="m1 5 4-4 4 4"/></svg> 
                        ...
                        <div className="listSvg2">
                        <li onClick={listToggleCompany}>Company</li>
                        {isCompany ? <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" strokeWidth="1.5" fill="none" d="m1 5 4-4 4 4"/></svg> 
                        : <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" strokeWidth="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>}
                        </div>   
